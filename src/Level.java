...
public class Level
{
	...
	public int checkCollisionX(PointD location) { return checkCollisionX(location.x, location.y); }
	...
	public int checkCollisionY(PointD location) { return checkCollisionY(location.x, location.y); }
	...
	public Level getNext() { return next; }
	public Level getWarpzone() { return warpzone; }
	public EntityChain[] getEntities() { return entities; }
	public ArrayList<MovingEntity> getMovingEntities() { return movingEntities; }
	public Entity getEntity(int x, int y) { return entitiesMap[x][y]; }
	public void setWarpzone(Level warpzone) { this.warpzone = warpzone; }
	
	public void clearEntity(int x, int y) { entitiesMap[x][y] = null; }
	public void init()
	{
		int x, y;
